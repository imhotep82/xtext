  ...
  public CharSequence target() {
    ...
    _builder.newLine();
    {
      ...
      if (_equals) {
        ...
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-jupiter-engine\" version=\"[6.0.0,7.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-jupiter-migrationsupport\" version=\"[6.0.0,7.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-jupiter-params\" version=\"[6.0.0,7.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-platform-commons\" version=\"[6.0.0,7.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-platform-engine\" version=\"[6.0.0,7.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-platform-launcher\" version=\"[6.0.0,7.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-platform-suite-api\" version=\"[6.0.0,7.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
